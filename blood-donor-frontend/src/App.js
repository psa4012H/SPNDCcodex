...
export default function App() {
  ...
  return (
    <Container component="main" maxWidth="xs">
      <CssBaseline />
      <Paper elevation={12} sx={{ mt: 8, p: 4, borderRadius: 6 }}>
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <Box component="form" onSubmit={view === "login" ? handleLogin : handleSignup} sx={{ mt: 2 }}>
            {view === "signup" && (
              <>
                <TextField
                  margin="normal"
          ...
          {token && (
            <Box sx={{ mt: 1 }}>
              <b>JWT Token:</b> <span style={{ wordBreak: "break-all" }}>{token}</span>
            </Box>
          )}
        </Box>
      </Paper>
